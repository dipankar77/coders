<?php class trobica_about extends WP_Widget {

	// Defines the widget name
	public function __construct() {
		parent::__construct(false, $name = __('About Us Widget', 'trobica_plg') );
	}
	...
	function form($instance) {
		...
		<p>
		<label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Title:', 'trobica_plg'); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
		</p>
        <p>
		<label for="<?php echo $this->get_field_id('subtitle'); ?>"><?php esc_html_e('Subtitle (text below title):', 'trobica_plg'); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('subtitle'); ?>" name="<?php echo $this->get_field_name('subtitle'); ?>" type="text" value="<?php echo $subtitle; ?>" />
		</p>
		<p>
	    <label for="<?php echo $this->get_field_id('image_uri'); ?>"><?php esc_html_e('About Us Image:', 'trobica_plg'); ?></label><br />
		...
		<p>
	    <input type="button" value="<?php esc_html_e( 'Upload Image', 'trobica_plg' ); ?>" class="button about_btn_upload" id="about_button"/>
	    </p><br />
		
		<p>
		<label for="<?php echo $this->get_field_id('textarea'); ?>"><?php esc_html_e('Textarea:', 'trobica_plg'); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('social'); ?>"><?php esc_html_e('Social Media:', 'trobica_plg'); ?></label><br />
		</p>
		
		<p>
        <label for="<?php echo $this->get_field_id( 'facebook' ); ?>"><?php esc_html_e('Facebook', 'trobica_plg'); ?></label> 
        <input class="widefat" id="<?php echo $this->get_field_id( 'facebook' ); ?>" name="<?php echo $this->get_field_name( 'facebook' ); ?>" type="text" value="<?php echo esc_attr( $facebook ); ?>" />
		</p>
		
		<p>
        <label for="<?php echo $this->get_field_id( 'twitter' ); ?>"><?php esc_html_e('Twitter', 'trobica_plg'); ?></label> 
        <input class="widefat" id="<?php echo $this->get_field_id( 'twitter' ); ?>" name="<?php echo $this->get_field_name( 'twitter' ); ?>" type="text" value="<?php echo esc_attr( $twitter ); ?>"  />
		</p>

		<p>
        <label for="<?php echo $this->get_field_id( 'google' ); ?>"><?php esc_html_e('Google', 'trobica_plg'); ?></label> 
        <input class="widefat" id="<?php echo $this->get_field_id( 'google' ); ?>" name="<?php echo $this->get_field_name( 'google' ); ?>" type="text" value="<?php echo esc_attr( $google ); ?>" />
		</p>

		<p>
        <label for="<?php echo $this->get_field_id( 'instagram' ); ?>"><?php esc_html_e('Instagram', 'trobica_plg'); ?></label> 
        <input class="widefat" id="<?php echo $this->get_field_id( 'instagram' ); ?>" name="<?php echo $this->get_field_name( 'instagram' ); ?>" type="text" value="<?php echo esc_attr( $instagram ); ?>" />
		</p>

		<p>
        <label for="<?php echo $this->get_field_id( 'pinterest' ); ?>"><?php esc_html_e('Pinterest', 'trobica_plg'); ?></label> 
		...
		<p>
        <label for="<?php echo $this->get_field_id( 'youtube' ); ?>"><?php esc_html_e('Youtube', 'trobica_plg'); ?></label> 
        <input class="widefat" id="<?php echo $this->get_field_id( 'youtube' ); ?>" name="<?php echo $this->get_field_name( 'youtube' ); ?>" type="text" value="<?php echo esc_attr( $youtube ); ?>"/>
		</p>
		<p>
        <label for="<?php echo $this->get_field_id( 'linkedin' ); ?>"><?php esc_html_e('Linkedin', 'trobica_plg'); ?></label> 
		   ...
		   if ( $title ) { ?>
		     <div class="bordering-widget">
                  ...
                  <?php 
					...
					if ($twitter or $facebook or $google or $instagram or $pinterest or $youtube or $linkedin) {
...
function register_about_us() {
	register_widget( 'trobica_about' );
}
add_action( 'widgets_init', 'register_about_us' );

// Load scripts in admin area
if( !function_exists ('trobica_about_scripts') ) :
	function trobica_about_scripts(){

	  wp_enqueue_media();
	  // Media upload script
	  wp_enqueue_script('trobica_about_upload', plugin_dir_url( __FILE__ ) . 'js/about-me.js');

	}
	add_action('admin_enqueue_scripts', 'trobica_about_scripts');
endif; // end trobica_about_scripts