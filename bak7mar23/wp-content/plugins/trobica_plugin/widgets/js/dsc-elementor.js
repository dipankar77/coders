(function($) {
    ...
    $("#elementor-preview-iframe").on("load", function() {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/trobica-mason-gallery.default', function($scope) {
			 $scope.find('.mason-gallery').imagesLoaded(function() { 
			 	$scope.find('.mason-gallery').isotope();
			 });
		});
		elementorFrontend.hooks.addAction('frontend/element_ready/trobica-post-four.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/trobica-testimonial.default', function($scope) {
		...
		//for post slider
        elementorFrontend.hooks.addAction('frontend/element_ready/trobica-post-slider.default', function($scope) {
        ...
        //for menu
        elementorFrontend.hooks.addAction('frontend/element_ready/trobica-menu.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/trobica-portfolio-info.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/trobica-portfolio.default', function($scope) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/trobica-portfolio-masonry.default', function($scope) {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/trobica-sidebar.default', function($scope) {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/trobica-texticon-hover.default', function($scope) {
			$scope.find('.box-padding').each(function() {
				$(this).closest('.elementor-column-wrap').addClass('hovering');
			});
		});
		
		elementorFrontend.hooks.addAction('frontend/element_ready/trobica-team-hover.default', function($scope) {
			$scope.find('.box-padding').each(function() {
				$(this).closest('.elementor-column-wrap').addClass('hovering');
			});
		});
