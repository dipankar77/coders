 ...
 * @since 1.0.0
 */
class Trobica_Contact extends Widget_Base {
	...
	public function get_title() {
		return __( 'Trobica Contact Form Shortcode', 'trobica_plg' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'shortcode',
			[
				'label' => __( 'Insert your contact form shortcode here', 'trobica_plg' ),
		...
		$this->start_controls_section(
			'form_settings',
			[
				'label' => __( 'Form Setting','trobica_plg' ),
		...
		$this->add_control(
			'form_placeholder',
			[
				'label' => __( 'Placeholder Color','trobica_plg' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Border Color on Focus','trobica_plg' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render() {
		...
		?>
		<div class="trobica-contact-shortcode"><?php echo $shortcode; ?></div>
		<?php
	}
