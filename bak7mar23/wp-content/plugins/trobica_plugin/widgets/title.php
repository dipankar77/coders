 ...
 * @since 1.0.0
 */
class Trobica_Title extends Widget_Base {
	...
	public function get_title() {
		return __( 'Trobica Heading', 'trobica_plg' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'title',
			[
				'label' => __( 'Title. <br/><small>You can use &lt;span&gt;&lt;/span&gt; tag for text color.</small>', 'trobica_plg' ),
				'type' => Controls_Manager::TEXTAREA,
				'placeholder' => __( 'Enter your title', 'trobica_plg' ),
				'default' => __( 'This is heading element', 'trobica_plg' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => __( 'Justified', 'trobica_plg' ),
