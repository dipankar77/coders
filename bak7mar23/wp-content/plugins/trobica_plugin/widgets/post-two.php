 ...
 * @since 1.0.0
 */
class Trobica_Post_Two extends Widget_Base {
	...
	public function get_title() {
		return __( 'Trobica Post List Style 2', 'trobica_plg' );
	}
	                        ...
	                        if  ($settings['blog_column'] == 'three') {echo "col-md-4"; } if  ($settings['blog_column'] == 'four') {echo "col-md-3"; } ?>">
	                        	<div class="blog-col-inner">
	                                ...
	                                <div class="excerpt-box pb-20 pt-20">
	                                    ...
	                                    <ul class="post-meta">
	                                        <li><span class="inti-meta"><?php esc_html_e('By','trobica_plg') ?></span> <?php the_author_posts_link(); ?></li>
	                                        <li><span class="inti-meta"><?php esc_html_e('On ','trobica_plg') ?></span><?php echo get_the_date(); ?></li>
	                                        <?php if  (has_tag()) { ?>
	                                        <li><span class="inti-meta"><?php esc_html_e('Tag','trobica_plg') ?></span> <?php the_tags(' : ');?></li>
	                                        <?php } ?>
	                                    </ul>
	                                    <?php } ?>
