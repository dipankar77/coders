		            ...
		            <div class="swiper-container parallax-slider">
		                                    ...
		                                    <div class="col-lg-12">
		                                        <div class="caption">
		                                            ...
		                                            <h1>
	                                                	...
	                                                	<?php endif; ?>
	                                                    <span class="title" data-swiper-parallax="-100"><?php echo wp_kses_post ( $item['title'] ); ?></span>
		                ...
		                <div class="slider-contro">
		                    <div class="swiper-button-next swiper-nav-ctrl cursor-pointer">
		                        <div>
		                            <span class="next-ctrl">Next Slide</span>
		                        </div>
		                    ...
		                    <div class="swiper-button-prev swiper-nav-ctrl cursor-pointer">
		                        ...
		                        <div>
		                            <span class="prev-ctrl">Prev Slide</span>
		                        </div>
		                    </div>
		                </div>
