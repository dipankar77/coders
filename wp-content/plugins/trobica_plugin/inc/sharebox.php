  ...
  ?>
	<div class="hidden share-remove">
      <div class="share-box">
         ...
         title="<?php esc_html_e("Share on Facebook", "trobica_plg"); ?>">
         ...
         title="<?php esc_html_e("Pin This", "trobica_plg"); ?>">
         ...
         title="<?php esc_html_e("Share on Google+", "trobica_plg"); ?>">
