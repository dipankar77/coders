 ...
 * @since 1.0.0
 */
class Trobica_Post_Three extends Widget_Base {
	...
	public function get_title() {
		return __( 'Trobica Post List Style 3', 'trobica_plg' );
	}
	...
	protected function render() {
		...
		?>
	        			<div class="blog-post-list row clearfix blog-body blog-style-3">
	                        <?php $count = 0;
