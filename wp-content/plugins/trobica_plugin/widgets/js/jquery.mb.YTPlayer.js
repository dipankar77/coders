	...
	jQuery.mbYTPlayer = {
		...
		buildPlayer: function( options ) {
			return this.each( function() {
				...
				YTPlayer.filtersEnabtrobica = true;
		...
		applyFilter: function( filter, value ) {
			return this.each( function() {
				...
				if( YTPlayer.filtersEnabtrobica )
		...
		toggleFilter: function( filter, value ) {
			return this.each( function() {
				...
				if( YTPlayer.filtersEnabtrobica ) jQuery( this ).YTPEnableFilters();
			} );
		},
		...
		toggleFilters: function( callback ) {
			return this.each( function() {
				...
				if( typeof callback == "function" )
					callback( YTPlayer.filtersEnabtrobica );
			} )
		},
		...
		disableFilters: function() {
			return this.each( function() {
				...
				iframe.css( "filter", "" );
				YTPlayer.filtersEnabtrobica = false;
			} )
		},
